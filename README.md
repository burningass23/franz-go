...
![GitHub](https://img.shields.io/github/license/burningass23/franz-go)
[![Discord Chat](https://img.shields.io/badge/discord-online-brightgreen.svg)](https://discord.gg/K4R5c8zsMS)

[godev]: https://pkg.go.dev/github.com/burningass23/franz-go/pkg/kgo
...
[KADMC]: https://pkg.go.dev/github.com/burningass23/franz-go/pkg/kadm
[SRC]: https://pkg.go.dev/github.com/burningass23/franz-go/pkg/sr
...
The main client is located in the package `github.com/burningass23/franz-go/pkg/kgo`,
while the root of the project is at `github.com/burningass23/franz-go`. There are
a few extra packages within the project, as well as a few sub-modules. To
use the main kgo package,

```
go get github.com/burningass23/franz-go
```

To use a plugin,

```
go get github.com/burningass23/franz-go/plugin/kzap
```

To use kadm,

```
go get github.com/burningass23/franz-go/pkg/kadm
```
...
```
require (
	github.com/burningass23/franz-go v1.12.0
...
or comment on [#142](https://github.com/burningass23/franz-go/issues/142)!
...
modules, e.g. `github.com/burningass23/franz-go/plugin/kprom@v1.0.0`.
